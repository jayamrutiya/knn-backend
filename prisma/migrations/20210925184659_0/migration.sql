/*
  ...
  - Added the required column `shifts` to the `Event` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `event` ADD COLUMN `eligibility` TEXT NOT NULL,
    ADD COLUMN `fee` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `isFree` BOOLEAN NOT NULL,
    ADD COLUMN `registrationEndAt` TIMESTAMP(6),
    ADD COLUMN `shifts` VARCHAR(256) NOT NULL,
    ADD COLUMN `venue` VARCHAR(256) NOT NULL,
