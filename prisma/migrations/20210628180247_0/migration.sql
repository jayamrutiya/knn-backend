...
-- AlterTable
ALTER TABLE `subscription` ADD COLUMN     `deposite` DECIMAL(10, 2) NOT NULL DEFAULT 0.0,
    MODIFY `noOfBook` INTEGER NOT NULL DEFAULT 0,
...
-- AlterTable
ALTER TABLE `usersubscription` ADD COLUMN     `deposite` DECIMAL(10, 2) NOT NULL DEFAULT 0.0,
    MODIFY `noOfBook` INTEGER NOT NULL DEFAULT 0,
    MODIFY `updatedAt` TIMESTAMP;

-- AlterTable
ALTER TABLE `usersubscriptionusage` MODIFY `noOfBookUploaded` INTEGER NOT NULL DEFAULT 0,
    MODIFY `priceDeposited` DECIMAL(10, 2) NOT NULL DEFAULT 0.0,
    MODIFY `updatedAt` TIMESTAMP;
