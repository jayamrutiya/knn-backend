...
const createUserValidator = express_validator_1.checkSchema({
    firstName: {
        in: 'body',
        trim: true,
        exists: {
    ...
    password: {
        ...
        matches: {
            ...
            errorMessage: 'Password should be combination of one uppercase , one lower case, one special char, one digit and min 8 , max 20 characters long',
        },
        stripLow: true,
    },
    address: {
